            ...
            for p0_idx_0, (k_cache_iter_3, out_iter_3, v_cache_iter_3) in pl.range(0, tok_blocks_0, 1, init_values=(k_cache_iter_1, out_iter_1, v_cache_iter_1)):
                ...
                with pl.auto_incore():
                    ...
                    for ob_0, (k0_iter_1, kb_iter_1, q_proj_tile_iter_1, x_chunk_iter_1) in pl.parallel(0, 80, 1, init_values=(k0_0, kb_0, q_proj_tile_0, x_chunk_0), chunk=8):
                        ...
                        q_proj_tile_3: pl.Tensor[[4, 5120], pl.BFLOAT16] = pl.tensor.assemble(q_proj_tile_iter_1, _t9, [0, q0_0])
                    ...
                    for ob_1, (gamma_iter_1, k0_iter_6, k_proj_tile_iter_1, kb_iter_4, normed_iter_1, v_proj_tile_iter_1, x_chunk_iter_6) in pl.parallel(0, 32, 1, init_values=(gamma_0, k0_2, k_proj_tile_0, kb_2, normed_0, v_proj_tile_0, x_chunk_2), chunk=8):
                        ...
                        k_proj_tile_3: pl.Tensor[[4, 1024], pl.BFLOAT16] = pl.tensor.assemble(k_proj_tile_iter_1, _t14, [0, kv0_0])
                        _t15: pl.Tensor[[4, 32], pl.BFLOAT16] = pl.tensor.cast(v_acc_3, target_type=pl.BFLOAT16, mode=2)
                        v_proj_tile_3: pl.Tensor[[4, 1024], pl.BFLOAT16] = pl.tensor.assemble(v_proj_tile_iter_1, _t15, [0, kv0_0])
                    ...
                    for ti_0, (attn_tile_iter_2, k_cache_iter_5, v_cache_iter_5) in pl.range(0, valid_tok_0, 1, init_values=(attn_tile_1, k_cache_iter_3, v_cache_iter_3)):
                        ...
                        for h_0, (attn_row_iter_2, k_cache_iter_7, v_cache_iter_7) in pl.parallel(0, 64, 1, init_values=(attn_row_1, k_cache_iter_5, v_cache_iter_5), chunk=8):
                            ...
                            if h_0 % 8 == 0:
                                ...
                                _t16: pl.Tensor[[1, 128], pl.BFLOAT16] = pl.tensor.view(k_proj_tile_2, [1, 128], [ti_0, kv_col_0])
                                ...
                                k_cache_9: pl.Tensor[[524288, 128], pl.BFLOAT16] = pl.tensor.assemble(k_cache_iter_7, _t23, [cache_row_0, 0])
                                _t24: pl.Tensor[[1, 128], pl.BFLOAT16] = pl.tensor.view(v_proj_tile_2, [1, 128], [ti_0, kv_col_0])
                                v_cache_9: pl.Tensor[[524288, 128], pl.BFLOAT16] = pl.tensor.assemble(v_cache_iter_7, _t24, [cache_row_0, 0])
                                k_cache_10, v_cache_10 = pl.yield_(k_cache_9, v_cache_9)
                            else:
                                k_cache_10, v_cache_10 = pl.yield_(k_cache_iter_7, v_cache_iter_7)
                            _t25: pl.Tensor[[1, 128], pl.BFLOAT16] = pl.tensor.view(q_proj_tile_2, [1, 128], [ti_0, q_col_0])
                ...
                with pl.auto_incore():
                    ...
                    for ob_2, (k0_iter_11, kb_iter_7, resid1_tile_iter_1) in pl.parallel(0, 80, 1, init_values=(k0_7, kb_5, resid1_tile_0), chunk=8):
                        ...
                        resid1_tile_3: pl.Tensor[[4, 5120], pl.FP32] = pl.tensor.assemble(resid1_tile_iter_1, _t46, [0, o0_0])
                    ...
                    for ob_3, (down_proj_tile_iter_2, k0_iter_22, kb_iter_12, o0_iter_1, out_iter_5) in pl.range(0, 100, 1, init_values=(down_proj_tile_1, k0_20, kb_11, o0_0, out_iter_3)):
                        ...
                        for dob_0, (down_proj_tile_iter_4, out_iter_7) in pl.parallel(0, 80, 1, init_values=(down_proj_tile_iter_2, out_iter_5), chunk=8):
                            ...
                            if ob_3 == 100 - 1:
                                ...
                                _t61: pl.Tensor[[4, 64], pl.FP32] = pl.tensor.view(resid1_tile_2, [4, 64], [0, d0_0])
                                ...
                                out_9: pl.Tensor[[16, 4096, 5120], pl.BFLOAT16] = pl.tensor.assemble(out_iter_7, _t62, [b_0, p0_0, d0_0])
