        ...
        with pl.auto_incore():
            ...
            for b0_0, (k0_iter_1, kb_iter_1, kv_a_iter_1, q_proj_iter_1, qr_iter_1, x_chunk_iter_1) in pl.range(0, 16, 4, init_values=(k0_0, kb_0, kv_a_0, q_proj_0, qr_0, x_chunk_0)):
                ...
                for ob_0, (k0_iter_3, kb_iter_3, qr_iter_3, x_chunk_iter_3) in pl.parallel(0, 12, 1, init_values=(k0_iter_1, kb_iter_1, qr_iter_1, x_chunk_iter_1), chunk=4):
                    ...
                    qr_5: pl.Tensor[[16, 1536], pl.BFLOAT16] = pl.tensor.assemble(qr_iter_3, _t9, [b0_0, q0_0])
                ...
                for ob_1, (gamma_iter_1, k0_iter_8, kb_iter_6, q0_iter_1, q_acc_iter_5, q_proj_iter_3, wq_chunk_iter_1) in pl.parallel(0, 48, 1, init_values=(gamma_0, k0_4, kb_4, q0_0, q_acc_3, q_proj_iter_1, wq_chunk_0), chunk=8):
                    ...
                    for kb_8, (gamma_iter_3, k0_iter_10, q_acc_iter_9, wq_chunk_iter_3) in pl.range(0, 12, 1, init_values=(gamma_iter_1, k0_iter_8, q_acc_8, wq_chunk_iter_1)):
                        ...
                        _t10: pl.Tensor[[4, 128], pl.BFLOAT16] = pl.tensor.view(qr_4, [4, 128], [b0_0, k0_12])
                    ...
                    q_proj_5: pl.Tensor[[16, 128 * 192], pl.BFLOAT16] = pl.tensor.assemble(q_proj_iter_3, _t13, [b0_0, q0_3])
                ...
                for ob_2, (gamma_iter_6, k0_iter_13, kb_iter_9, kv_a_iter_3, normed_iter_1, x_chunk_iter_8, x_chunk_bf16_iter_1) in pl.parallel(0, 5, 1, init_values=(gamma_2, k0_9, kb_7, kv_a_iter_1, normed_0, x_chunk_4, x_chunk_bf16_0), chunk=8):
                    ...
                    kv_a_5: pl.Tensor[[16, 576], pl.BFLOAT16] = pl.tensor.assemble(kv_a_iter_3, _t17, [b0_0, kv0_0])
        ...
        for b_0, (attn_front_iter_1, kv_cache_iter_1, pe_cache_iter_1) in pl.parallel(0, 16, 1, init_values=(attn_front_0, kv_cache_0, pe_cache_0), chunk=4):
            ...
            with pl.auto_incore():
                ...
                for h_0, (attn_row_iter_2, kk_iter_10, s_iter_1) in pl.parallel(0, 128, 1, init_values=(attn_row_1, kk_8, s_0), chunk=8):
                    ...
                    _t52: pl.Tensor[[128, 512], pl.BFLOAT16] = pl.tensor.view(w_q_nope_to_latent_0, [128, 512], [h_0, 0, 0])
