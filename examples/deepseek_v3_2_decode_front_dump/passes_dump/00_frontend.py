...
class DeepSeekV32DecodeFront:
    @pl.function
    def deepseek_v3_2_decode_front_layer(self, hidden_states: pl.Tensor[[16, 7168], pl.BFLOAT16], seq_lens: pl.Tensor[[16], pl.INT32], layer_id_t: pl.Tensor[[1], pl.INT32], rope_cos: pl.Tensor[[4096, 64], pl.FP32], rope_sin: pl.Tensor[[4096, 64], pl.FP32], kv_cache: pl.Tensor[[65536, 512], pl.BFLOAT16], pe_cache: pl.Tensor[[65536, 64], pl.BFLOAT16], input_rms_weight: pl.Tensor[[1, 7168], pl.FP32], wq_a: pl.Tensor[[7168, 1536], pl.BFLOAT16], q_norm_weight: pl.Tensor[[1, 1536], pl.FP32], wq_b: pl.Tensor[[1536, 24576], pl.BFLOAT16], wkv_a: pl.Tensor[[7168, 576], pl.BFLOAT16], kv_norm_weight: pl.Tensor[[1, 512], pl.FP32], w_q_nope_to_latent: pl.Tensor[[128, 128, 512], pl.BFLOAT16], w_latent_to_v: pl.Tensor[[128, 512, 128], pl.BFLOAT16], dispatch_buf: pl.Tensor[[128, 16, 16384], pl.BFLOAT16]) -> pl.Tensor[[128, 16, 16384], pl.BFLOAT16]:
        layer_id: pl.Scalar[pl.INT32] = pl.tensor.read(layer_id_t, [0])
        qr: pl.Tensor[[16, 1536], pl.BFLOAT16] = pl.tensor.create([16, 1536], dtype=pl.BFLOAT16)
        q_proj: pl.Tensor[[16, 128 * 192], pl.BFLOAT16] = pl.tensor.create([16, 128 * 192], dtype=pl.BFLOAT16)
        kv_a: pl.Tensor[[16, 576], pl.BFLOAT16] = pl.tensor.create([16, 576], dtype=pl.BFLOAT16)
        attn_front: pl.Tensor[[16, 16384], pl.FP32] = pl.tensor.create([16, 16384], dtype=pl.FP32)
        with pl.auto_incore():
            ...
            for kb in pl.range(0, 14, 1):
                ...
                x_chunk: pl.Tensor[[16, 512], pl.FP32] = pl.tensor.cast(pl.tensor.view(hidden_states, [16, 512], [0, k0]), target_type=pl.FP32, mode=2)
                sq_sum: pl.Tensor[[16, 1], pl.FP32] = pl.tensor.add(sq_sum, pl.tensor.row_sum(pl.tensor.mul(x_chunk, x_chunk)))
            inv_rms: pl.Tensor[[16, 1], pl.FP32] = pl.tensor.rsqrt(pl.tensor.add(pl.tensor.mul(sq_sum, 0.000139509), 1e-06))
            for b0 in pl.range(0, 16, 4):
                inv_rms_tile: pl.Tensor[[4, 1], pl.FP32] = pl.tensor.view(inv_rms, [4, 1], [b0, 0])
                inv_rms_tile: pl.Tensor[[4, 1], pl.FP32] = pl.tensor.add(inv_rms_tile, pl.tensor.mul(usage_pad_sum, 0.0))
                for ob in pl.parallel(0, 12, 1, chunk=4):
                    q0: pl.Scalar[pl.INDEX] = ob * 128
                    q_acc: pl.Tensor[[4, 128], pl.FP32] = pl.tensor.create([4, 128], dtype=pl.FP32)
                    q_acc: pl.Tensor[[4, 128], pl.FP32] = pl.tensor.mul(q_acc, 0.0)
                    for kb in pl.range(0, 14, 1):
                        k0: pl.Scalar[pl.INDEX] = kb * 512
                        x_chunk_bf16: pl.Tensor[[4, 512], pl.BFLOAT16] = pl.tensor.view(hidden_states, [4, 512], [b0, k0])
                        x_chunk: pl.Tensor[[4, 512], pl.FP32] = pl.tensor.cast(x_chunk_bf16, target_type=pl.FP32, mode=2)
                        gamma: pl.Tensor[[1, 512], pl.FP32] = pl.tensor.view(input_rms_weight, [1, 512], [0, k0])
                        normed: pl.Tensor[[4, 512], pl.FP32] = pl.tensor.col_expand_mul(pl.tensor.row_expand_mul(x_chunk, inv_rms_tile), gamma)
                        wq_chunk: pl.Tensor[[512, 128], pl.BFLOAT16] = pl.tensor.view(wq_a, [512, 128], [k0, q0])
                        q_acc: pl.Tensor[[4, 128], pl.FP32] = pl.tensor.add(q_acc, pl.tensor.matmul(pl.tensor.cast(normed, target_type=pl.BFLOAT16, mode=2), wq_chunk, a_trans=False, b_trans=False, c_matrix_nz=False))
                    qr: pl.Tensor[[16, 1536], pl.BFLOAT16] = pl.tensor.assemble(qr, pl.tensor.cast(q_acc, target_type=pl.BFLOAT16, mode=2), [b0, q0])
                for ob in pl.parallel(0, 48, 1, chunk=8):
                    q0: pl.Scalar[pl.INDEX] = ob * 512
                    q_acc: pl.Tensor[[4, 512], pl.FP32] = pl.tensor.create([4, 512], dtype=pl.FP32)
                    q_acc: pl.Tensor[[4, 512], pl.FP32] = pl.tensor.mul(q_acc, 0.0)
                    for kb in pl.range(0, 12, 1):
                        k0: pl.Scalar[pl.INDEX] = kb * 128
                        q_chunk: pl.Tensor[[4, 128], pl.FP32] = pl.tensor.cast(pl.tensor.view(qr, [4, 128], [b0, k0]), target_type=pl.FP32, mode=2)
                        gamma: pl.Tensor[[1, 128], pl.FP32] = pl.tensor.view(q_norm_weight, [1, 128], [0, k0])
                        qn: pl.Tensor[[4, 128], pl.FP32] = pl.tensor.col_expand_mul(q_chunk, gamma)
                        wq_chunk: pl.Tensor[[128, 512], pl.BFLOAT16] = pl.tensor.view(wq_b, [128, 512], [k0, q0])
                        q_acc: pl.Tensor[[4, 512], pl.FP32] = pl.tensor.add(q_acc, pl.tensor.matmul(pl.tensor.cast(qn, target_type=pl.BFLOAT16, mode=2), wq_chunk, a_trans=False, b_trans=False, c_matrix_nz=False))
                    q_proj: pl.Tensor[[16, 128 * 192], pl.BFLOAT16] = pl.tensor.assemble(q_proj, pl.tensor.cast(q_acc, target_type=pl.BFLOAT16, mode=2), [b0, q0])
                for ob in pl.parallel(0, 5, 1, chunk=8):
                    ...
                    kv_a: pl.Tensor[[16, 576], pl.BFLOAT16] = pl.tensor.assemble(kv_a, pl.tensor.cast(kv_acc, target_type=pl.BFLOAT16, mode=2), [b0, kv0])
        for b in pl.parallel(0, 16, 1, chunk=4):
            ...
            kv_row: pl.Tensor[[1, 512], pl.FP32] = pl.tensor.cast(pl.tensor.view(kv_a, [1, 512], [b, 0]), target_type=pl.FP32, mode=2)
            ...
            pe_row: pl.Tensor[[1, 64], pl.FP32] = pl.tensor.cast(pl.tensor.view(kv_a, [1, 64], [b, 512]), target_type=pl.FP32, mode=2)
            ...
            with pl.auto_incore():
                ...
                q_nope0: pl.Tensor[[1, 128], pl.FP32] = pl.tensor.cast(pl.tensor.view(q_proj, [1, 128], [b, q_col0]), target_type=pl.FP32, mode=2)
                q_pe0: pl.Tensor[[1, 64], pl.FP32] = pl.tensor.cast(pl.tensor.view(q_proj, [1, 64], [b, q_col0 + 128]), target_type=pl.FP32, mode=2)
                ...
                sparse_k_gen: pl.Scalar[pl.INDEX] = min(2048, pl.cast(ctx_len, pl.INDEX))
                for blk in pl.range(0, 2, 1):
                    blk_start: pl.Scalar[pl.INDEX] = blk * 2048
                    blk_end: pl.Scalar[pl.INDEX] = min(pl.cast(ctx_len, pl.INDEX), blk_start + 2048)
                ...
                for h in pl.parallel(0, 128, 1, chunk=8):
                    ...
                    q_nope: pl.Tensor[[1, 128], pl.FP32] = pl.tensor.cast(pl.tensor.view(q_proj, [1, 128], [b, q_col]), target_type=pl.FP32, mode=2)
                    q_pe: pl.Tensor[[1, 64], pl.FP32] = pl.tensor.cast(pl.tensor.view(q_proj, [1, 64], [b, q_col + 128]), target_type=pl.FP32, mode=2)
                    ...
                    sparse_k: pl.Scalar[pl.INDEX] = min(2048, pl.cast(ctx_len, pl.INDEX))
                ...
                attn_front: pl.Tensor[[16, 16384], pl.FP32] = pl.tensor.assemble(attn_front, attn_row, [b, 0])
        for b in pl.parallel(0, 16, 1, chunk=4):
            target_node: pl.Scalar[pl.INDEX] = (b + pl.cast(layer_id, pl.INDEX)) % 128
            token_row: pl.Tensor[[1, 16384], pl.BFLOAT16] = pl.tensor.cast(pl.tensor.view(attn_front, [1, 16384], [b, 0]), target_type=pl.BFLOAT16, mode=2)
            dispatch_buf: pl.Tensor[[128, 16, 16384], pl.BFLOAT16] = pl.tensor.assemble(dispatch_buf, token_row, [target_node, b, 0])
        return dispatch_buf