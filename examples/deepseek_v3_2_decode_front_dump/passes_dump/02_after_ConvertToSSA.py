    ...
    def deepseek_v3_2_decode_front_layer(self, hidden_states_0: pl.Tensor[[16, 7168], pl.BFLOAT16], seq_lens_0: pl.Tensor[[16], pl.INT32], layer_id_t_0: pl.Tensor[[1], pl.INT32], rope_cos_0: pl.Tensor[[4096, 64], pl.FP32], rope_sin_0: pl.Tensor[[4096, 64], pl.FP32], kv_cache_0: pl.Tensor[[65536, 512], pl.BFLOAT16], pe_cache_0: pl.Tensor[[65536, 64], pl.BFLOAT16], input_rms_weight_0: pl.Tensor[[1, 7168], pl.FP32], wq_a_0: pl.Tensor[[7168, 1536], pl.BFLOAT16], q_norm_weight_0: pl.Tensor[[1, 1536], pl.FP32], wq_b_0: pl.Tensor[[1536, 24576], pl.BFLOAT16], wkv_a_0: pl.Tensor[[7168, 576], pl.BFLOAT16], kv_norm_weight_0: pl.Tensor[[1, 512], pl.FP32], w_q_nope_to_latent_0: pl.Tensor[[128, 128, 512], pl.BFLOAT16], w_latent_to_v_0: pl.Tensor[[128, 512, 128], pl.BFLOAT16], dispatch_buf_0: pl.Tensor[[128, 16, 16384], pl.BFLOAT16]) -> pl.Tensor[[128, 16, 16384], pl.BFLOAT16]:
        ...
        with pl.auto_incore():
            ...
            for kb_0, (sq_sum_iter_2,) in pl.range(0, 14, 1, init_values=(sq_sum_1,)):
                ...
                x_chunk_0: pl.Tensor[[16, 512], pl.FP32] = pl.tensor.cast(pl.tensor.view(hidden_states_0, [16, 512], [0, k0_0]), target_type=pl.FP32, mode=2)
            ...
            inv_rms_0: pl.Tensor[[16, 1], pl.FP32] = pl.tensor.rsqrt(pl.tensor.add(pl.tensor.mul(sq_sum_3, 0.000139509), 1e-06))
            for b0_0, (k0_iter_1, kb_iter_1, kv_a_iter_1, q_proj_iter_1, qr_iter_1, x_chunk_iter_1) in pl.range(0, 16, 4, init_values=(k0_0, kb_0, kv_a_0, q_proj_0, qr_0, x_chunk_0)):
                ...
                inv_rms_tile_1: pl.Tensor[[4, 1], pl.FP32] = pl.tensor.add(inv_rms_tile_0, pl.tensor.mul(usage_pad_sum_0, 0.0))
                for ob_0, (k0_iter_3, kb_iter_3, qr_iter_3, x_chunk_iter_3) in pl.parallel(0, 12, 1, init_values=(k0_iter_1, kb_iter_1, qr_iter_1, x_chunk_iter_1), chunk=4):
                    q0_0: pl.Scalar[pl.INDEX] = ob_0 * 128
                    q_acc_0: pl.Tensor[[4, 128], pl.FP32] = pl.tensor.create([4, 128], dtype=pl.FP32)
                    q_acc_1: pl.Tensor[[4, 128], pl.FP32] = pl.tensor.mul(q_acc_0, 0.0)
                    for kb_5, (k0_iter_5, q_acc_iter_2, x_chunk_iter_5) in pl.range(0, 14, 1, init_values=(k0_iter_3, q_acc_1, x_chunk_iter_3)):
                        k0_7: pl.Scalar[pl.INDEX] = kb_5 * 512
                        x_chunk_bf16_0: pl.Tensor[[4, 512], pl.BFLOAT16] = pl.tensor.view(hidden_states_0, [4, 512], [b0_0, k0_7])
                        x_chunk_7: pl.Tensor[[4, 512], pl.FP32] = pl.tensor.cast(x_chunk_bf16_0, target_type=pl.FP32, mode=2)
                        gamma_0: pl.Tensor[[1, 512], pl.FP32] = pl.tensor.view(input_rms_weight_0, [1, 512], [0, k0_7])
                        normed_0: pl.Tensor[[4, 512], pl.FP32] = pl.tensor.col_expand_mul(pl.tensor.row_expand_mul(x_chunk_7, inv_rms_tile_1), gamma_0)
                        wq_chunk_0: pl.Tensor[[512, 128], pl.BFLOAT16] = pl.tensor.view(wq_a_0, [512, 128], [k0_7, q0_0])
                        q_acc_4: pl.Tensor[[4, 128], pl.FP32] = pl.tensor.add(q_acc_iter_2, pl.tensor.matmul(pl.tensor.cast(normed_0, target_type=pl.BFLOAT16, mode=2), wq_chunk_0, a_trans=False, b_trans=False, c_matrix_nz=False))
                        k0_6, q_acc_3, x_chunk_6 = pl.yield_(k0_7, q_acc_4, x_chunk_7)
                    qr_5: pl.Tensor[[16, 1536], pl.BFLOAT16] = pl.tensor.assemble(qr_iter_3, pl.tensor.cast(q_acc_3, target_type=pl.BFLOAT16, mode=2), [b0_0, q0_0])
                    k0_4, kb_4, qr_4, x_chunk_4 = pl.yield_(k0_6, kb_5, qr_5, x_chunk_6)
                for ob_1, (gamma_iter_1, k0_iter_8, kb_iter_6, q0_iter_1, q_acc_iter_5, q_proj_iter_3, wq_chunk_iter_1) in pl.parallel(0, 48, 1, init_values=(gamma_0, k0_4, kb_4, q0_0, q_acc_3, q_proj_iter_1, wq_chunk_0), chunk=8):
                    q0_3: pl.Scalar[pl.INDEX] = ob_1 * 512
                    q_acc_7: pl.Tensor[[4, 512], pl.FP32] = pl.tensor.create([4, 512], dtype=pl.FP32)
                    q_acc_8: pl.Tensor[[4, 512], pl.FP32] = pl.tensor.mul(q_acc_7, 0.0)
                    for kb_8, (gamma_iter_3, k0_iter_10, q_acc_iter_9, wq_chunk_iter_3) in pl.range(0, 12, 1, init_values=(gamma_iter_1, k0_iter_8, q_acc_8, wq_chunk_iter_1)):
                        k0_12: pl.Scalar[pl.INDEX] = kb_8 * 128
                        q_chunk_0: pl.Tensor[[4, 128], pl.FP32] = pl.tensor.cast(pl.tensor.view(qr_4, [4, 128], [b0_0, k0_12]), target_type=pl.FP32, mode=2)
                        gamma_5: pl.Tensor[[1, 128], pl.FP32] = pl.tensor.view(q_norm_weight_0, [1, 128], [0, k0_12])
                        qn_0: pl.Tensor[[4, 128], pl.FP32] = pl.tensor.col_expand_mul(q_chunk_0, gamma_5)
                        wq_chunk_5: pl.Tensor[[128, 512], pl.BFLOAT16] = pl.tensor.view(wq_b_0, [128, 512], [k0_12, q0_3])
                        q_acc_11: pl.Tensor[[4, 512], pl.FP32] = pl.tensor.add(q_acc_iter_9, pl.tensor.matmul(pl.tensor.cast(qn_0, target_type=pl.BFLOAT16, mode=2), wq_chunk_5, a_trans=False, b_trans=False, c_matrix_nz=False))
                        gamma_4, k0_11, q_acc_10, wq_chunk_4 = pl.yield_(gamma_5, k0_12, q_acc_11, wq_chunk_5)
                    q_proj_5: pl.Tensor[[16, 128 * 192], pl.BFLOAT16] = pl.tensor.assemble(q_proj_iter_3, pl.tensor.cast(q_acc_10, target_type=pl.BFLOAT16, mode=2), [b0_0, q0_3])
                    gamma_2, k0_9, kb_7, q0_2, q_acc_6, q_proj_4, wq_chunk_2 = pl.yield_(gamma_4, k0_11, kb_8, q0_3, q_acc_10, q_proj_5, wq_chunk_4)
                for ob_2, (gamma_iter_6, k0_iter_13, kb_iter_9, kv_a_iter_3, normed_iter_1, x_chunk_iter_8, x_chunk_bf16_iter_1) in pl.parallel(0, 5, 1, init_values=(gamma_2, k0_9, kb_7, kv_a_iter_1, normed_0, x_chunk_4, x_chunk_bf16_0), chunk=8):
                    kv0_0: pl.Scalar[pl.INDEX] = ob_2 * 128
                    ...
                    for kb_11, (gamma_iter_8, k0_iter_15, kv_acc_iter_2, normed_iter_3, x_chunk_iter_10, x_chunk_bf16_iter_3) in pl.range(0, 14, 1, init_values=(gamma_iter_6, k0_iter_13, kv_acc_1, normed_iter_1, x_chunk_iter_8, x_chunk_bf16_iter_1)):
                        ...
                        normed_5: pl.Tensor[[4, 512], pl.FP32] = pl.tensor.col_expand_mul(pl.tensor.row_expand_mul(x_chunk_12, inv_rms_tile_1), gamma_10)
                        wkv_chunk_0: pl.Tensor[[512, 128], pl.BFLOAT16] = pl.tensor.view(wkv_a_0, [512, 128], [k0_17, kv0_0])
                        kv_acc_4: pl.Tensor[[4, 128], pl.FP32] = pl.tensor.add(kv_acc_iter_2, pl.tensor.matmul(pl.tensor.cast(normed_5, target_type=pl.BFLOAT16, mode=2), wkv_chunk_0, a_trans=False, b_trans=False, c_matrix_nz=False))
        ...
        for b_0, (attn_front_iter_1, kv_cache_iter_1, pe_cache_iter_1) in pl.parallel(0, 16, 1, init_values=(attn_front_0, kv_cache_0, pe_cache_0), chunk=4):
            ...
            with pl.auto_incore():
                ...
                q_nope0_0: pl.Tensor[[1, 128], pl.FP32] = pl.tensor.cast(pl.tensor.view(q_proj_2, [1, 128], [b_0, q_col0_0]), target_type=pl.FP32, mode=2)
                q_pe0_0: pl.Tensor[[1, 64], pl.FP32] = pl.tensor.cast(pl.tensor.view(q_proj_2, [1, 64], [b_0, q_col0_0 + 128]), target_type=pl.FP32, mode=2)
                ...
                q0_rot_1: pl.Tensor[[1, 64], pl.FP32] = pl.tensor.assemble(q0_rot_0, pl.tensor.sub(pl.tensor.col_expand_mul(q0_lo_0, cos_lo_0), pl.tensor.col_expand_mul(q0_hi_0, sin_lo_0)), [0, 0])
                q0_rot_2: pl.Tensor[[1, 64], pl.FP32] = pl.tensor.assemble(q0_rot_1, pl.tensor.add(pl.tensor.col_expand_mul(q0_hi_0, cos_hi_0), pl.tensor.col_expand_mul(q0_lo_0, sin_hi_0)), [0, 64 // 2])
                q0_nope_latent_0: pl.Tensor[[1, 512], pl.BFLOAT16] = pl.tensor.matmul(pl.tensor.cast(q_nope0_0, target_type=pl.BFLOAT16, mode=2), pl.tensor.view(w_q_nope_to_latent_0, [128, 512], [0, 0, 0]), a_trans=False, b_trans=False, c_matrix_nz=False)
                ...
                for blk_0, (blk_topk_idx_iter_6, blk_topk_vals_iter_2, kk_iter_1) in pl.range(0, 2, 1, init_values=(blk_topk_idx_3, blk_topk_vals_1, kk_0)):
                    ...
                    for ss_0, (blk_topk_idx_iter_8, blk_topk_vals_iter_4, kk_iter_3) in pl.range(0, 2048, 1, init_values=(blk_topk_idx_iter_6, blk_topk_vals_iter_2, kk_iter_1)):
                        ...
                        if s_0 < blk_end_0:
                            ...
                            kv_s_0: pl.Tensor[[1, 512], pl.FP32] = pl.tensor.cast(pl.tensor.view(kv_cache_3, [1, 512], [cache_s_0, 0]), target_type=pl.FP32, mode=2)
                            pe_s_0: pl.Tensor[[1, 64], pl.FP32] = pl.tensor.cast(pl.tensor.view(pe_cache_3, [1, 64], [cache_s_0, 0]), target_type=pl.FP32, mode=2)
                            score_nope_0: pl.Tensor[[1, 1], pl.FP32] = pl.tensor.row_sum(pl.tensor.mul(q0_nope_latent_0, kv_s_0))
                            score_pe_0: pl.Tensor[[1, 1], pl.FP32] = pl.tensor.row_sum(pl.tensor.mul(q0_rot_2, pe_s_0))
                            score_fp32_0: pl.Tensor[[1, 1], pl.FP32] = pl.tensor.mul(pl.tensor.add(score_nope_0, score_pe_0), 0.0721688)
                ...
                for h_0, (attn_row_iter_2, kk_iter_10, s_iter_1) in pl.parallel(0, 128, 1, init_values=(attn_row_1, kk_8, s_0), chunk=8):
                    ...
                    q_rot_1: pl.Tensor[[1, 64], pl.FP32] = pl.tensor.assemble(q_rot_0, pl.tensor.sub(pl.tensor.col_expand_mul(q_lo_0, cos_lo_0), pl.tensor.col_expand_mul(q_hi_0, sin_lo_0)), [0, 0])
                    q_rot_2: pl.Tensor[[1, 64], pl.FP32] = pl.tensor.assemble(q_rot_1, pl.tensor.add(pl.tensor.col_expand_mul(q_hi_0, cos_hi_0), pl.tensor.col_expand_mul(q_lo_0, sin_hi_0)), [0, 64 // 2])
                    q_nope_latent_0: pl.Tensor[[1, 512], pl.BFLOAT16] = pl.tensor.matmul(pl.tensor.cast(q_nope_0, target_type=pl.BFLOAT16, mode=2), pl.tensor.view(w_q_nope_to_latent_0, [128, 512], [h_0, 0, 0]), a_trans=False, b_trans=False, c_matrix_nz=False)
                    ...
                    for kk_12, (li_iter_2, mi_iter_2, oi_iter_2, s_iter_3) in pl.range(0, sparse_k_0, 1, init_values=(li_1, mi_1, oi_1, s_iter_1)):
                        s_5: pl.Scalar[pl.INDEX] = pl.tensor.read(topk_idx_6, [0, kk_12])
                        if s_5 >= 0:
                            cache_s_1: pl.Scalar[pl.INDEX] = b_0 * 4096 + s_5
                            kv_s_1: pl.Tensor[[1, 512], pl.FP32] = pl.tensor.cast(pl.tensor.view(kv_cache_3, [1, 512], [cache_s_1, 0]), target_type=pl.FP32, mode=2)
                            pe_s_1: pl.Tensor[[1, 64], pl.FP32] = pl.tensor.cast(pl.tensor.view(pe_cache_3, [1, 64], [cache_s_1, 0]), target_type=pl.FP32, mode=2)
                            score_nope_1: pl.Tensor[[1, 1], pl.FP32] = pl.tensor.row_sum(pl.tensor.mul(q_nope_latent_0, kv_s_1))
                            score_pe_1: pl.Tensor[[1, 1], pl.FP32] = pl.tensor.row_sum(pl.tensor.mul(q_rot_2, pe_s_1))
                            score_0: pl.Tensor[[1, 1], pl.FP32] = pl.tensor.mul(pl.tensor.add(score_nope_1, score_pe_1), 0.0721688)
                            cur_mi_0: pl.Tensor[[1, 1], pl.FP32] = score_0
                            cur_li_0: pl.Tensor[[1, 1], pl.FP32] = pl.tensor.exp(pl.tensor.sub(score_0, cur_mi_0))
                            ...
                            if kk_12 == 0:
                                ...
                                oi_5: pl.Tensor[[1, 512], pl.FP32] = pl.tensor.add(pl.tensor.row_expand_mul(oi_iter_2, alpha_0), pl.tensor.row_expand_mul(oi_tmp_0, beta_0))
                    ...
                    v_col_0: pl.Scalar[pl.INDEX] = h_0 * 128
                    ...
                    for vb_0, (ctx_v_iter_2,) in pl.range(0, 2, 1, init_values=(ctx_v_1,)):
                        ...
                        wv_tile_0: pl.Tensor[[512, 64], pl.BFLOAT16] = pl.tensor.view(w_latent_to_v_0, [512, 64], [h_0, 0, v0_0])
                        v_part_0: pl.Tensor[[1, 64], pl.FP32] = pl.tensor.matmul(pl.tensor.cast(ctx_latent_0, target_type=pl.BFLOAT16, mode=2), wv_tile_0, a_trans=False, b_trans=False, c_matrix_nz=False, out_dtype=pl.FP32)
