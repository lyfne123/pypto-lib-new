    ...
    def deepseek_v3_2_decode_front_layer(self, hidden_states_0: pl.Tensor[[16, 7168], pl.BFLOAT16], seq_lens_0: pl.Tensor[[16], pl.INT32], layer_id_t_0: pl.Tensor[[1], pl.INT32], rope_cos_0: pl.Tensor[[4096, 64], pl.FP32], rope_sin_0: pl.Tensor[[4096, 64], pl.FP32], kv_cache_0: pl.Tensor[[65536, 512], pl.BFLOAT16], pe_cache_0: pl.Tensor[[65536, 64], pl.BFLOAT16], input_rms_weight_0: pl.Tensor[[1, 7168], pl.FP32], wq_a_0: pl.Tensor[[7168, 1536], pl.BFLOAT16], q_norm_weight_0: pl.Tensor[[1, 1536], pl.FP32], wq_b_0: pl.Tensor[[1536, 24576], pl.BFLOAT16], wkv_a_0: pl.Tensor[[7168, 576], pl.BFLOAT16], kv_norm_weight_0: pl.Tensor[[1, 512], pl.FP32], w_q_nope_to_latent_0: pl.Tensor[[128, 128, 512], pl.BFLOAT16], w_latent_to_v_0: pl.Tensor[[128, 512, 128], pl.BFLOAT16], dispatch_buf_0: pl.Tensor[[128, 16, 16384], pl.BFLOAT16]) -> pl.Tensor[[128, 16, 16384], pl.BFLOAT16]:
        ...
        with pl.auto_incore():
            ...
            for b0_0, (k0_iter_1, kb_iter_1, kv_a_iter_1, q_proj_iter_1, qr_iter_1, x_chunk_iter_1) in pl.range(0, 16, 4, init_values=(k0_0, kb_0, kv_a_0, q_proj_0, qr_0, x_chunk_0)):
                ...
                for ob_0_out, (k0_iter_3_outer, kb_iter_3_outer, qr_iter_3_outer, x_chunk_iter_3_outer) in pl.range(0, 3, 1, init_values=(k0_iter_1, kb_iter_1, qr_iter_1, x_chunk_iter_1)):
                    for ob_0_in, (k0_iter_3_inner, kb_iter_3_inner, qr_iter_3_inner, x_chunk_iter_3_inner) in pl.parallel(0, 4, 1, init_values=(k0_iter_3_outer, kb_iter_3_outer, qr_iter_3_outer, x_chunk_iter_3_outer)):
                        ...
                        for kb_5, (k0_iter_5, q_acc_iter_2, x_chunk_iter_5) in pl.range(0, 14, 1, init_values=(k0_iter_3_inner, q_acc_1, x_chunk_iter_3_inner)):
                            ...
                            _t7: pl.Tensor[[4, 512], pl.BFLOAT16] = pl.tensor.cast(normed_0, target_type=pl.BFLOAT16, mode=2)
                            _t8: pl.Tensor[[4, 128], pl.BFLOAT16] = pl.tensor.matmul(_t7, wq_chunk_0, a_trans=False, b_trans=False, c_matrix_nz=False)
                            q_acc_4: pl.Tensor[[4, 128], pl.FP32] = pl.tensor.add(q_acc_iter_2, _t8)
                            k0_6, q_acc_3, x_chunk_6 = pl.yield_(k0_7, q_acc_4, x_chunk_7)
                        _t9: pl.Tensor[[4, 128], pl.BFLOAT16] = pl.tensor.cast(q_acc_3, target_type=pl.BFLOAT16, mode=2)
                        qr_5: pl.Tensor[[16, 1536], pl.BFLOAT16] = pl.tensor.assemble(qr_iter_3_inner, _t9, [b0_0, q0_0])
                        k0_iter_3_inner_rv, kb_iter_3_inner_rv, qr_iter_3_inner_rv, x_chunk_iter_3_inner_rv = pl.yield_(k0_6, kb_5, qr_5, x_chunk_6)
                    k0_iter_3_outer_rv, kb_iter_3_outer_rv, qr_iter_3_outer_rv, x_chunk_iter_3_outer_rv = pl.yield_(k0_iter_3_inner_rv, kb_iter_3_inner_rv, qr_iter_3_inner_rv, x_chunk_iter_3_inner_rv)
                for ob_1_out, (gamma_iter_1_outer, k0_iter_8_outer, kb_iter_6_outer, q0_iter_1_outer, q_acc_iter_5_outer, q_proj_iter_3_outer, wq_chunk_iter_1_outer) in pl.range(0, 6, 1, init_values=(gamma_0, k0_4, kb_4, q0_0, q_acc_3, q_proj_iter_1, wq_chunk_0)):
                    for ob_1_in, (gamma_iter_1_inner, k0_iter_8_inner, kb_iter_6_inner, q0_iter_1_inner, q_acc_iter_5_inner, q_proj_iter_3_inner, wq_chunk_iter_1_inner) in pl.parallel(0, 8, 1, init_values=(gamma_iter_1_outer, k0_iter_8_outer, kb_iter_6_outer, q0_iter_1_outer, q_acc_iter_5_outer, q_proj_iter_3_outer, wq_chunk_iter_1_outer)):
                        ...
                        for kb_8, (gamma_iter_3, k0_iter_10, q_acc_iter_9, wq_chunk_iter_3) in pl.range(0, 12, 1, init_values=(gamma_iter_1_inner, k0_iter_8_inner, q_acc_8, wq_chunk_iter_1_inner)):
                            k0_12: pl.Scalar[pl.INDEX] = kb_8 * 128
                            _t10: pl.Tensor[[4, 128], pl.BFLOAT16] = pl.tensor.view(qr_iter_3_outer_rv, [4, 128], [b0_0, k0_12])
                            q_chunk_0: pl.Tensor[[4, 128], pl.FP32] = pl.tensor.cast(_t10, target_type=pl.FP32, mode=2)
                            ...
                            _t11: pl.Tensor[[4, 128], pl.BFLOAT16] = pl.tensor.cast(qn_0, target_type=pl.BFLOAT16, mode=2)
                            _t12: pl.Tensor[[4, 512], pl.BFLOAT16] = pl.tensor.matmul(_t11, wq_chunk_5, a_trans=False, b_trans=False, c_matrix_nz=False)
                            q_acc_11: pl.Tensor[[4, 512], pl.FP32] = pl.tensor.add(q_acc_iter_9, _t12)
                            gamma_4, k0_11, q_acc_10, wq_chunk_4 = pl.yield_(gamma_5, k0_12, q_acc_11, wq_chunk_5)
                        _t13: pl.Tensor[[4, 512], pl.BFLOAT16] = pl.tensor.cast(q_acc_10, target_type=pl.BFLOAT16, mode=2)
                        q_proj_5: pl.Tensor[[16, 128 * 192], pl.BFLOAT16] = pl.tensor.assemble(q_proj_iter_3_inner, _t13, [b0_0, q0_3])
                        gamma_iter_1_inner_rv, k0_iter_8_inner_rv, kb_iter_6_inner_rv, q0_iter_1_inner_rv, q_acc_iter_5_inner_rv, q_proj_iter_3_inner_rv, wq_chunk_iter_1_inner_rv = pl.yield_(gamma_4, k0_11, kb_8, q0_3, q_acc_10, q_proj_5, wq_chunk_4)
                    gamma_iter_1_outer_rv, k0_iter_8_outer_rv, kb_iter_6_outer_rv, q0_iter_1_outer_rv, q_acc_iter_5_outer_rv, q_proj_iter_3_outer_rv, wq_chunk_iter_1_outer_rv = pl.yield_(gamma_iter_1_inner_rv, k0_iter_8_inner_rv, kb_iter_6_inner_rv, q0_iter_1_inner_rv, q_acc_iter_5_inner_rv, q_proj_iter_3_inner_rv, wq_chunk_iter_1_inner_rv)
                ...
                k0_2, kb_2, kv_a_2, q_proj_2, qr_2, x_chunk_2 = pl.yield_(k0_iter_13_rem_rv, kb_iter_9_rem_rv, kv_a_iter_3_rem_rv, q_proj_iter_3_outer_rv, qr_iter_3_outer_rv, x_chunk_iter_8_rem_rv)
            ...
            with pl.auto_incore():
                ...
                for h_0_out, (attn_row_iter_2_outer, kk_iter_10_outer, s_iter_1_outer) in pl.range(0, 16, 1, init_values=(attn_row_1, kk_8, s_0)):
                    for h_0_in, (attn_row_iter_2_inner, kk_iter_10_inner, s_iter_1_inner) in pl.parallel(0, 8, 1, init_values=(attn_row_iter_2_outer, kk_iter_10_outer, s_iter_1_outer)):
                        ...
                        _t43: pl.Tensor[[1, 128], pl.BFLOAT16] = pl.tensor.view(q_proj_2, [1, 128], [b_0, q_col_0])
                        q_nope_0: pl.Tensor[[1, 128], pl.FP32] = pl.tensor.cast(_t43, target_type=pl.FP32, mode=2)
                        _t44: pl.Tensor[[1, 64], pl.BFLOAT16] = pl.tensor.view(q_proj_2, [1, 64], [b_0, q_col_0 + 128])
                        q_pe_0: pl.Tensor[[1, 64], pl.FP32] = pl.tensor.cast(_t44, target_type=pl.FP32, mode=2)
                        ...
                        _t51: pl.Tensor[[1, 128], pl.BFLOAT16] = pl.tensor.cast(q_nope_0, target_type=pl.BFLOAT16, mode=2)
                        _t52: pl.Tensor[[128, 512], pl.BFLOAT16] = pl.tensor.view(w_q_nope_to_latent_0, [128, 512], [0 + (h_0_out * 8 + h_0_in) * 1, 0, 0])
                        ...
                        for vb_0, (ctx_v_iter_2,) in pl.range(0, 2, 1, init_values=(ctx_v_1,)):
                            ...
                            _t65: pl.Tensor[[1, 512], pl.BFLOAT16] = pl.tensor.cast(ctx_latent_0, target_type=pl.BFLOAT16, mode=2)
                ...
                attn_front_3: pl.Tensor[[16, 16384], pl.FP32] = pl.tensor.assemble(attn_front_iter_1, attn_row_iter_2_outer_rv, [b_0, 0])
