            ...
            for p0_idx_0, (dispatch_buf_iter_3, kv_cache_iter_3, pe_cache_iter_3) in pl.range(0, tok_blocks_0, 1, init_values=(dispatch_buf_iter_1, kv_cache_iter_1, pe_cache_iter_1)):
                ...
                with pl.auto_incore():
                    ...
                    for ob_0, (k0_iter_1, kb_iter_1, q_proj_tile_iter_1, x_chunk_iter_1) in pl.parallel(0, 96, 1, init_values=(k0_0, kb_0, q_proj_tile_0, x_chunk_0), chunk=8):
                        ...
                        q_proj_tile_3: pl.Tensor[[4, 128 * 192], pl.BFLOAT16] = pl.tensor.assemble(q_proj_tile_iter_1, _t11, [0, q0_0])
                ...
                with pl.auto_incore():
                    ...
                    for ti_0, (attn_tile_iter_2, kv_cache_iter_5, pe_cache_iter_5) in pl.range(0, valid_tok_0, 1, init_values=(attn_tile_1, kv_cache_iter_3, pe_cache_iter_3)):
                        ...
                        _t17: pl.Tensor[[1, 512], pl.BFLOAT16] = pl.tensor.view(kv_a_tile_2, [1, 512], [ti_0, 0])
                        ...
                        _t18: pl.Tensor[[1, 64], pl.BFLOAT16] = pl.tensor.view(kv_a_tile_2, [1, 64], [ti_0, 512])
                        ...
                        _t27: pl.Tensor[[1, 128], pl.BFLOAT16] = pl.tensor.view(q_proj_tile_2, [1, 128], [ti_0, q_col0_0])
                        q_nope0_0: pl.Tensor[[1, 128], pl.FP32] = pl.tensor.cast(_t27, target_type=pl.FP32, mode=2)
                        _t28: pl.Tensor[[1, 64], pl.BFLOAT16] = pl.tensor.view(q_proj_tile_2, [1, 64], [ti_0, q_col0_0 + 128])
                        ...
                        for h_0, (attn_row_iter_2, kk_iter_10, s_iter_1) in pl.parallel(0, 128, 1, init_values=(attn_row_1, kk_8, s_0), chunk=8):
                            ...
                            _t42: pl.Tensor[[1, 128], pl.BFLOAT16] = pl.tensor.view(q_proj_tile_2, [1, 128], [ti_0, q_col_0])
                            q_nope_0: pl.Tensor[[1, 128], pl.FP32] = pl.tensor.cast(_t42, target_type=pl.FP32, mode=2)
                            _t43: pl.Tensor[[1, 64], pl.BFLOAT16] = pl.tensor.view(q_proj_tile_2, [1, 64], [ti_0, q_col_0 + 128])
                            ...
                            _t51: pl.Tensor[[128, 512], pl.BFLOAT16] = pl.tensor.view(w_q_nope_to_latent_0, [128, 512], [h_0, 0, 0])
