...
class DeepSeekV32PrefillFront:
        ...
        for b_0, (dispatch_buf_iter_1, kv_cache_iter_1, pe_cache_iter_1) in pl.parallel(0, 16, 1, init_values=(dispatch_buf_0, kv_cache_0, pe_cache_0), chunk=4):
            ...
            for p0_idx_0, (dispatch_buf_iter_3, kv_cache_iter_3, pe_cache_iter_3) in pl.range(0, tok_blocks_0, 1, init_values=(dispatch_buf_iter_1, kv_cache_iter_1, pe_cache_iter_1)):
                ...
                for ob_0_out, (k0_iter_1_outer_l0, kb_iter_1_outer_l0, q_proj_tile_iter_1_outer_l0, x_chunk_iter_1_outer_l0) in pl.range(0, 12, 1, init_values=(k0_0, kb_0, q_proj_tile_0, x_chunk_0)):
                    ...
                    q_proj_tile_iter_1_outer_l1_rv: pl.Tensor[[4, 128 * 192], pl.BFLOAT16] = ret[2]
                    x_chunk_iter_1_outer_l1_rv: pl.Tensor[[4, 512], pl.FP32] = ret[3]
                ...
                for ti_0, (attn_tile_iter_2, kv_cache_iter_5, pe_cache_iter_5) in pl.range(0, valid_tok_0, 1, init_values=(attn_tile_1, kv_cache_iter_3, pe_cache_iter_3)):
                    ...
                    _t27: pl.Tensor[[1, 128], pl.BFLOAT16] = pl.tensor.view(q_proj_tile_iter_1_outer_l0_rv, [1, 128], [ti_0, q_col0_0])
                    q_nope0_0: pl.Tensor[[1, 128], pl.FP32] = pl.tensor.cast(_t27, target_type=pl.FP32, mode=2)
                    _t28: pl.Tensor[[1, 64], pl.BFLOAT16] = pl.tensor.view(q_proj_tile_iter_1_outer_l0_rv, [1, 64], [ti_0, q_col0_0 + 128])
                    ...
                    attn_tile_4: pl.Tensor[[4, 16384], pl.FP32] = pl.tensor.assemble(attn_tile_iter_2, attn_row_iter_2_outer_l0_rv, [ti_0, 0])
    ...
    def deepseek_v3_2_prefill_front_layer_incore_0_aic(self, b_0: pl.Scalar[pl.INDEX], hidden_states_0: pl.Tensor[[16, 4096, 7168], pl.BFLOAT16], input_rms_weight_0: pl.Tensor[[1, 7168], pl.FP32], inv_rms_1: pl.Tensor[[4, 1], pl.FP32], k0_0: pl.Scalar[pl.INDEX], k0_iter_1_outer_l0: pl.Scalar[pl.INDEX], kb_0: pl.Scalar[pl.INDEX], kb_iter_1_outer_l0: pl.Scalar[pl.INDEX], ob_0_out: pl.Scalar[pl.INDEX], p0_0: pl.Scalar[pl.INDEX], q_norm_weight_0: pl.Tensor[[1, 1536], pl.FP32], q_proj_tile_0: pl.Tensor[[4, 128 * 192], pl.BFLOAT16], q_proj_tile_iter_1_outer_l0: pl.Tensor[[4, 128 * 192], pl.BFLOAT16], wq_a_0: pl.Tensor[[7168, 1536], pl.BFLOAT16], wq_b_0: pl.Tensor[[1536, 24576], pl.BFLOAT16], x_chunk_0: pl.Tensor[[4, 512], pl.FP32], x_chunk_iter_1_outer_l0: pl.Tensor[[4, 512], pl.FP32]) -> tuple[pl.Scalar[pl.INDEX], pl.Scalar[pl.INDEX], pl.Tensor[[4, 128 * 192], pl.BFLOAT16], pl.Tensor[[4, 512], pl.FP32]]:
        ...
        for ob_0_in, (k0_iter_1_outer_l1, kb_iter_1_outer_l1, q_proj_tile_iter_1_outer_l1, x_chunk_iter_1_outer_l1) in pl.parallel(0, 8, 1, init_values=(k0_iter_1_outer_l0, kb_iter_1_outer_l0, q_proj_tile_iter_1_outer_l0, x_chunk_iter_1_outer_l0)):
            ...
            for kb_3, (k0_iter_3, x_chunk_iter_3) in pl.range(0, 14, 1, init_values=(k0_iter_1_outer_l1, x_chunk_iter_1_outer_l1)):
                ...
                for rb_0 in pl.range(0, 12, 1):
                    ...
                    wq_a_chunk_0__h0: pl.Tensor[[256, 128], pl.BFLOAT16] = pl.comm.tpop_from_aiv(0)
                    wq_a_chunk_0__h1: pl.Tensor[[256, 128], pl.BFLOAT16] = pl.comm.tpop_from_aiv(1)
                    wq_a_chunk_0__tmp: pl.Tensor[[512, 128], pl.BFLOAT16] = pl.tensor.create(__list__(512, 128), dtype=pl.BFLOAT16)
                    wq_a_chunk_0__mid: pl.Tensor[[512, 128], pl.BFLOAT16] = pl.tensor.assemble(wq_a_chunk_0__tmp, wq_a_chunk_0__h0, __list__(0, 0))
                    pl.comm.tfree_to_aiv(0)
                    wq_a_chunk_0: pl.Tensor[[512, 128], pl.BFLOAT16] = pl.tensor.assemble(wq_a_chunk_0__mid, wq_a_chunk_0__h1, __list__(256, 0))
                    pl.comm.tfree_to_aiv(1)
                    _t8__h0: pl.Tensor[[2, 512], pl.BFLOAT16] = pl.comm.tpop_from_aiv(0)
                    _t8__h1: pl.Tensor[[2, 512], pl.BFLOAT16] = pl.comm.tpop_from_aiv(1)
                    _t8__tmp: pl.Tensor[[4, 512], pl.BFLOAT16] = pl.tensor.create(__list__(4, 512), dtype=pl.BFLOAT16)
                    _t8__mid: pl.Tensor[[4, 512], pl.BFLOAT16] = pl.tensor.assemble(_t8__tmp, _t8__h0, __list__(0, 0))
                    pl.comm.tfree_to_aiv(0)
                    _t8: pl.Tensor[[4, 512], pl.BFLOAT16] = pl.tensor.assemble(_t8__mid, _t8__h1, __list__(2, 0))
                    pl.comm.tfree_to_aiv(1)
                    qr_part_0: pl.Tensor[[4, 128], pl.BFLOAT16] = pl.tensor.matmul(_t8, wq_a_chunk_0, a_trans=False, b_trans=False, c_matrix_nz=False)
                    wq_b_chunk_0__h0: pl.Tensor[[64, 256], pl.BFLOAT16] = pl.comm.tpop_from_aiv(0)
                    wq_b_chunk_0__h1: pl.Tensor[[64, 256], pl.BFLOAT16] = pl.comm.tpop_from_aiv(1)
                    wq_b_chunk_0__tmp: pl.Tensor[[128, 256], pl.BFLOAT16] = pl.tensor.create(__list__(128, 256), dtype=pl.BFLOAT16)
                    wq_b_chunk_0__mid: pl.Tensor[[128, 256], pl.BFLOAT16] = pl.tensor.assemble(wq_b_chunk_0__tmp, wq_b_chunk_0__h0, __list__(0, 0))
                    pl.comm.tfree_to_aiv(0)
                    wq_b_chunk_0: pl.Tensor[[128, 256], pl.BFLOAT16] = pl.tensor.assemble(wq_b_chunk_0__mid, wq_b_chunk_0__h1, __list__(64, 0))
                    pl.comm.tfree_to_aiv(1)
                    _t9__h0: pl.Tensor[[2, 128], pl.BFLOAT16] = pl.comm.tpop_from_aiv(0)
                    _t9__h1: pl.Tensor[[2, 128], pl.BFLOAT16] = pl.comm.tpop_from_aiv(1)
                    _t9__tmp: pl.Tensor[[4, 128], pl.BFLOAT16] = pl.tensor.create(__list__(4, 128), dtype=pl.BFLOAT16)
                    _t9__mid: pl.Tensor[[4, 128], pl.BFLOAT16] = pl.tensor.assemble(_t9__tmp, _t9__h0, __list__(0, 0))
                    pl.comm.tfree_to_aiv(0)
                    _t9: pl.Tensor[[4, 128], pl.BFLOAT16] = pl.tensor.assemble(_t9__mid, _t9__h1, __list__(2, 0))
                    pl.comm.tfree_to_aiv(1)
                    _t10: pl.Tensor[[4, 256], pl.BFLOAT16] = pl.tensor.matmul(_t9, wq_b_chunk_0, a_trans=False, b_trans=False, c_matrix_nz=False)
                    __half0__: pl.Tensor[[2, 256], pl.BFLOAT16] = pl.tensor.view(_t10, __list__(2, 256), __list__(0, 0))
                    __half1__: pl.Tensor[[2, 256], pl.BFLOAT16] = pl.tensor.view(_t10, __list__(2, 256), __list__(2, 0))
    ...
    @pl.function(type=pl.FunctionType.InCore)
    def deepseek_v3_2_prefill_front_layer_incore_0_aiv(self, b_0: pl.Scalar[pl.INDEX], hidden_states_0: pl.Tensor[[16, 4096, 7168], pl.BFLOAT16], input_rms_weight_0: pl.Tensor[[1, 7168], pl.FP32], inv_rms_1: pl.Tensor[[4, 1], pl.FP32], k0_0: pl.Scalar[pl.INDEX], k0_iter_1_outer_l0: pl.Scalar[pl.INDEX], kb_0: pl.Scalar[pl.INDEX], kb_iter_1_outer_l0: pl.Scalar[pl.INDEX], ob_0_out: pl.Scalar[pl.INDEX], p0_0: pl.Scalar[pl.INDEX], q_norm_weight_0: pl.Tensor[[1, 1536], pl.FP32], q_proj_tile_0: pl.Tensor[[4, 128 * 192], pl.BFLOAT16], q_proj_tile_iter_1_outer_l0: pl.Tensor[[4, 128 * 192], pl.BFLOAT16], wq_a_0: pl.Tensor[[7168, 1536], pl.BFLOAT16], wq_b_0: pl.Tensor[[1536, 24576], pl.BFLOAT16], x_chunk_0: pl.Tensor[[4, 512], pl.FP32], x_chunk_iter_1_outer_l0: pl.Tensor[[4, 512], pl.FP32], AIV_IDX: pl.Scalar[pl.INDEX]) -> tuple[pl.Scalar[pl.INDEX], pl.Scalar[pl.INDEX], pl.Tensor[[4, 128 * 192], pl.BFLOAT16], pl.Tensor[[4, 512], pl.FP32]]:
        inv_rms_1_tile: pl.Tile[[4, 1], pl.FP32, tile_view=pl.TileView(valid_shape=[4, 1], stride=[], start_offset=<unsupported IRNode type>, blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.none_box, fractal=512, pad=pl.TilePad.null)] = pl.block.load(inv_rms_1, [0, 0], [4, 1], [4, 1], target_memory=pl.MemorySpace.Vec)
        pl.comm.aiv_initialize_pipe()
        for ob_0_in, (k0_iter_1_outer_l1, kb_iter_1_outer_l1, q_proj_tile_iter_1_outer_l1, x_chunk_iter_1_outer_l1) in pl.parallel(0, 8, 1, init_values=(k0_iter_1_outer_l0, kb_iter_1_outer_l0, q_proj_tile_iter_1_outer_l0, x_chunk_iter_1_outer_l0)):
            q0_0: pl.Scalar[pl.INDEX] = (0 + (ob_0_out * 8 + ob_0_in) * 1) * 256
            q_acc_0: pl.Tensor[[2, 256], pl.FP32] = pl.tensor.create([2, 256], dtype=pl.FP32)
            ...
            for kb_3, (k0_iter_3, q_acc_iter_2, x_chunk_iter_3) in pl.range(0, 14, 1, init_values=(k0_iter_1_outer_l1, q_acc_1, x_chunk_iter_1_outer_l1)):
                k0_5: pl.Scalar[pl.INDEX] = kb_3 * 512
                _t6: pl.Tensor[[4, 256], pl.BFLOAT16] = pl.tensor.view(hidden_states_0, [4, 256], [b_0, p0_0 + AIV_IDX * 256, k0_5])
                x_chunk_5: pl.Tensor[[4, 256], pl.FP32] = pl.tensor.cast(_t6, target_type=pl.FP32, mode=2)
                gamma_in_0: pl.Tensor[[1, 256], pl.FP32] = pl.tensor.view(input_rms_weight_0, [1, 256], [0, k0_5 + AIV_IDX * 256])
                ...
                for rb_0, (q_acc_iter_4,) in pl.range(0, 12, 1, init_values=(q_acc_iter_2,)):
                    r0_0: pl.Scalar[pl.INDEX] = rb_0 * 128
                    wq_a_chunk_0: pl.Tensor[[256, 128], pl.BFLOAT16] = pl.tensor.view(wq_a_0, [256, 128], [k0_5 + AIV_IDX * 256, r0_0])
                    pl.comm.tpush_to_aic(wq_a_chunk_0, AIV_IDX)
                    _t8: pl.Tensor[[4, 256], pl.BFLOAT16] = pl.tensor.cast(normed_0, target_type=pl.BFLOAT16, mode=2)
                    pl.comm.tpush_to_aic(_t8, AIV_IDX)
                    gamma_q_0: pl.Tensor[[1, 64], pl.FP32] = pl.tensor.view(q_norm_weight_0, [1, 64], [0, r0_0 + AIV_IDX * 64])
                    wq_b_chunk_0: pl.Tensor[[64, 256], pl.BFLOAT16] = pl.tensor.view(wq_b_0, [64, 256], [r0_0 + AIV_IDX * 64, q0_0])
                    pl.comm.tpush_to_aic(wq_b_chunk_0, AIV_IDX)
                    _t10: pl.Tensor[[2, 256], pl.BFLOAT16] = pl.comm.tpop_from_aic(AIV_IDX)
                    q_acc_6: pl.Tensor[[2, 256], pl.FP32] = pl.tensor.add(q_acc_iter_4, _t10)
            ...
            _t11: pl.Tensor[[2, 256], pl.BFLOAT16] = pl.tensor.cast(q_acc_3, target_type=pl.BFLOAT16, mode=2)
            q_proj_tile_3: pl.Tensor[[4, 128 * 192], pl.BFLOAT16] = pl.tensor.assemble(q_proj_tile_iter_1_outer_l1, _t11, [0 + AIV_IDX * 2, q0_0])
    ...
    @pl.function(type=pl.FunctionType.InCore)
    def deepseek_v3_2_prefill_front_layer_incore_1_aic(self, attn_row_1: pl.Tensor[[1, 16384], pl.FP32], attn_row_iter_2_outer_l0: pl.Tensor[[1, 16384], pl.FP32], b_0: pl.Scalar[pl.INDEX], cos_hi_0: pl.Tensor[[1, 64 // 2], pl.FP32], cos_lo_0: pl.Tensor[[1, 64 // 2], pl.FP32], ctx_len_0: pl.Scalar[pl.INDEX], h_0_out: pl.Scalar[pl.INDEX], kk_8: pl.Scalar[pl.INDEX], kk_iter_10_outer_l0: pl.Scalar[pl.INDEX], kv_cache_7: pl.Tensor[[65536, 512], pl.BFLOAT16], pe_cache_7: pl.Tensor[[65536, 64], pl.BFLOAT16], q_proj_tile_iter_1_outer_l0_rv: pl.Tensor[[4, 128 * 192], pl.BFLOAT16], s_0: pl.Scalar[pl.INDEX], s_iter_1_outer_l0: pl.Scalar[pl.INDEX], sin_hi_0: pl.Tensor[[1, 64 // 2], pl.FP32], sin_lo_0: pl.Tensor[[1, 64 // 2], pl.FP32], ti_0: pl.Scalar[pl.INDEX], topk_idx_6: pl.Tensor[[1, 2048], pl.INDEX], w_latent_to_v_0: pl.Tensor[[128, 512, 128], pl.BFLOAT16], w_q_nope_to_latent_0: pl.Tensor[[128, 128, 512], pl.BFLOAT16]) -> tuple[pl.Tensor[[1, 16384], pl.FP32], pl.Scalar[pl.INDEX], pl.Scalar[pl.INDEX]]:
        pl.comm.aic_initialize_pipe()
        for h_0_in, (attn_row_iter_2_outer_l1, kk_iter_10_outer_l1, s_iter_1_outer_l1) in pl.parallel(0, 8, 1, init_values=(attn_row_iter_2_outer_l0, kk_iter_10_outer_l0, s_iter_1_outer_l0)):
            ...
            _t50: pl.Tensor[[1, 128], pl.BFLOAT16] = pl.comm.tpop_from_aiv()
            _t51__h0: pl.Tensor[[64, 512], pl.BFLOAT16] = pl.comm.tpop_from_aiv(0)
            _t51__h1: pl.Tensor[[64, 512], pl.BFLOAT16] = pl.comm.tpop_from_aiv(1)
            _t51__tmp: pl.Tensor[[128, 512], pl.BFLOAT16] = pl.tensor.create(__list__(128, 512), dtype=pl.BFLOAT16)
            _t51__mid: pl.Tensor[[128, 512], pl.BFLOAT16] = pl.tensor.assemble(_t51__tmp, _t51__h0, __list__(0, 0))
            pl.comm.tfree_to_aiv(0)
            _t51: pl.Tensor[[128, 512], pl.BFLOAT16] = pl.tensor.assemble(_t51__mid, _t51__h1, __list__(64, 0))
            pl.comm.tfree_to_aiv(1)
            ...
            for vb_0 in pl.range(0, 2, 1):
                ...
                pl.comm.tfree_to_aiv(1)
                _t64: pl.Tensor[[1, 512], pl.BFLOAT16] = pl.comm.tpop_from_aiv()
    ...
    @pl.function(type=pl.FunctionType.InCore)
    def deepseek_v3_2_prefill_front_layer_incore_1_aiv(self, attn_row_1: pl.Tensor[[1, 16384], pl.FP32], attn_row_iter_2_outer_l0: pl.Tensor[[1, 16384], pl.FP32], b_0: pl.Scalar[pl.INDEX], cos_hi_0: pl.Tensor[[1, 64 // 2], pl.FP32], cos_lo_0: pl.Tensor[[1, 64 // 2], pl.FP32], ctx_len_0: pl.Scalar[pl.INDEX], h_0_out: pl.Scalar[pl.INDEX], kk_8: pl.Scalar[pl.INDEX], kk_iter_10_outer_l0: pl.Scalar[pl.INDEX], kv_cache_7: pl.Tensor[[65536, 512], pl.BFLOAT16], pe_cache_7: pl.Tensor[[65536, 64], pl.BFLOAT16], q_proj_tile_iter_1_outer_l0_rv: pl.Tensor[[4, 128 * 192], pl.BFLOAT16], s_0: pl.Scalar[pl.INDEX], s_iter_1_outer_l0: pl.Scalar[pl.INDEX], sin_hi_0: pl.Tensor[[1, 64 // 2], pl.FP32], sin_lo_0: pl.Tensor[[1, 64 // 2], pl.FP32], ti_0: pl.Scalar[pl.INDEX], topk_idx_6: pl.Tensor[[1, 2048], pl.INDEX], w_latent_to_v_0: pl.Tensor[[128, 512, 128], pl.BFLOAT16], w_q_nope_to_latent_0: pl.Tensor[[128, 128, 512], pl.BFLOAT16], AIV_IDX: pl.Scalar[pl.INDEX]) -> tuple[pl.Tensor[[1, 16384], pl.FP32], pl.Scalar[pl.INDEX], pl.Scalar[pl.INDEX]]:
        ...
        for h_0_in, (attn_row_iter_2_outer_l1, kk_iter_10_outer_l1, s_iter_1_outer_l1) in pl.parallel(0, 8, 1, init_values=(attn_row_iter_2_outer_l0, kk_iter_10_outer_l0, s_iter_1_outer_l0)):
            q_col_0: pl.Scalar[pl.INDEX] = (0 + (h_0_out * 8 + h_0_in) * 1) * 192
            _t42: pl.Tensor[[1, 64], pl.BFLOAT16] = pl.tensor.view(q_proj_tile_iter_1_outer_l0_rv, [1, 64], [ti_0, q_col_0 + AIV_IDX * 64])
            q_nope_0: pl.Tensor[[1, 64], pl.FP32] = pl.tensor.cast(_t42, target_type=pl.FP32, mode=2)
            _t43: pl.Tensor[[1, 32], pl.BFLOAT16] = pl.tensor.view(q_proj_tile_iter_1_outer_l0_rv, [1, 32], [ti_0, q_col_0 + 128 + AIV_IDX * 32])
            q_pe_0: pl.Tensor[[1, 32], pl.FP32] = pl.tensor.cast(_t43, target_type=pl.FP32, mode=2)
            ...
            _t50: pl.Tensor[[1, 64], pl.BFLOAT16] = pl.tensor.cast(q_nope_0, target_type=pl.BFLOAT16, mode=2)
            pl.comm.tpush_to_aic(_t50, AIV_IDX)
            _t51: pl.Tensor[[64, 512], pl.BFLOAT16] = pl.tensor.view(w_q_nope_to_latent_0, [64, 512], [0 + (h_0_out * 8 + h_0_in) * 1 + AIV_IDX * 64, 0, 0])
            ...
            for vb_0, (ctx_v_iter_2,) in pl.range(0, 2, 1, init_values=(ctx_v_1,)):
                ...
                _t64: pl.Tensor[[1, 256], pl.BFLOAT16] = pl.tensor.cast(ctx_latent_0, target_type=pl.BFLOAT16, mode=2)
