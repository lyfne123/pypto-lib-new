            ...
            for p0_idx_0, (dispatch_buf_iter_3, kv_cache_iter_3, pe_cache_iter_3) in pl.range(0, tok_blocks_0, 1, init_values=(dispatch_buf_iter_1, kv_cache_iter_1, pe_cache_iter_1)):
                ...
                with pl.auto_incore():
                    ...
                    for kb_0, (sq_sum_iter_2,) in pl.range(0, 14, 1, init_values=(sq_sum_1,)):
                        ...
                        x_chunk_0: pl.Tensor[[4, 512], pl.FP32] = pl.tensor.cast(pl.tensor.view(hidden_states_0, [4, 512], [b_0, p0_0, k0_0]), target_type=pl.FP32, mode=2)
                    ...
                    inv_rms_0: pl.Tensor[[4, 1], pl.FP32] = pl.tensor.rsqrt(pl.tensor.add(pl.tensor.mul(sq_sum_3, 0.000139509), 1e-06))
                    inv_rms_1: pl.Tensor[[4, 1], pl.FP32] = pl.tensor.add(inv_rms_0, pl.tensor.mul(usage_pad_sum_0, 0.0))
                    ...
                    for ob_0, (k0_iter_1, kb_iter_1, q_proj_tile_iter_1, x_chunk_iter_1) in pl.parallel(0, 96, 1, init_values=(k0_0, kb_0, q_proj_tile_0, x_chunk_0), chunk=8):
                        q0_0: pl.Scalar[pl.INDEX] = ob_0 * 256
                        ...
                        for kb_3, (k0_iter_3, q_acc_iter_2, x_chunk_iter_3) in pl.range(0, 14, 1, init_values=(k0_iter_1, q_acc_1, x_chunk_iter_1)):
                            k0_5: pl.Scalar[pl.INDEX] = kb_3 * 512
                            x_chunk_5: pl.Tensor[[4, 512], pl.FP32] = pl.tensor.cast(pl.tensor.view(hidden_states_0, [4, 512], [b_0, p0_0, k0_5]), target_type=pl.FP32, mode=2)
                            gamma_in_0: pl.Tensor[[1, 512], pl.FP32] = pl.tensor.view(input_rms_weight_0, [1, 512], [0, k0_5])
                            normed_0: pl.Tensor[[4, 512], pl.FP32] = pl.tensor.col_expand_mul(pl.tensor.row_expand_mul(x_chunk_5, inv_rms_1), gamma_in_0)
                            for rb_0, (q_acc_iter_4,) in pl.range(0, 12, 1, init_values=(q_acc_iter_2,)):
                                ...
                                qr_part_0: pl.Tensor[[4, 128], pl.BFLOAT16] = pl.tensor.matmul(pl.tensor.cast(normed_0, target_type=pl.BFLOAT16, mode=2), wq_a_chunk_0, a_trans=False, b_trans=False, c_matrix_nz=False)
                                ...
                                q_acc_6: pl.Tensor[[4, 256], pl.FP32] = pl.tensor.add(q_acc_iter_4, pl.tensor.matmul(pl.tensor.cast(qn_part_0, target_type=pl.BFLOAT16, mode=2), wq_b_chunk_0, a_trans=False, b_trans=False, c_matrix_nz=False))
                                q_acc_5: pl.Tensor[[4, 256], pl.FP32] = pl.yield_(q_acc_6)
                            k0_4, q_acc_3, x_chunk_4 = pl.yield_(k0_5, q_acc_5, x_chunk_5)
                        q_proj_tile_3: pl.Tensor[[4, 128 * 192], pl.BFLOAT16] = pl.tensor.assemble(q_proj_tile_iter_1, pl.tensor.cast(q_acc_3, target_type=pl.BFLOAT16, mode=2), [0, q0_0])
                        k0_2, kb_2, q_proj_tile_2, x_chunk_2 = pl.yield_(k0_4, kb_3, q_proj_tile_3, x_chunk_4)
                    for ob_1, (k0_iter_6, kb_iter_4, kv_a_tile_iter_1, normed_iter_1, x_chunk_iter_6) in pl.parallel(0, 5, 1, init_values=(k0_2, kb_2, kv_a_tile_0, normed_0, x_chunk_2), chunk=8):
                        kv0_0: pl.Scalar[pl.INDEX] = ob_1 * 128
                        ...
                        for kb_6, (k0_iter_8, kv_acc_iter_2, normed_iter_3, x_chunk_iter_8) in pl.range(0, 14, 1, init_values=(k0_iter_6, kv_acc_1, normed_iter_1, x_chunk_iter_6)):
                            k0_10: pl.Scalar[pl.INDEX] = kb_6 * 512
                            x_chunk_10: pl.Tensor[[4, 512], pl.FP32] = pl.tensor.cast(pl.tensor.view(hidden_states_0, [4, 512], [b_0, p0_0, k0_10]), target_type=pl.FP32, mode=2)
                            gamma_0: pl.Tensor[[1, 512], pl.FP32] = pl.tensor.view(input_rms_weight_0, [1, 512], [0, k0_10])
                            normed_5: pl.Tensor[[4, 512], pl.FP32] = pl.tensor.col_expand_mul(pl.tensor.row_expand_mul(x_chunk_10, inv_rms_1), gamma_0)
                        ...
                        kv_a_tile_3: pl.Tensor[[4, 576], pl.BFLOAT16] = pl.tensor.assemble(kv_a_tile_iter_1, pl.tensor.cast(kv_acc_3, target_type=pl.BFLOAT16, mode=2), [0, kv0_0])
                ...
                with pl.auto_incore():
                    ...
                    for ti_0, (attn_tile_iter_2, kv_cache_iter_5, pe_cache_iter_5) in pl.range(0, valid_tok_0, 1, init_values=(attn_tile_1, kv_cache_iter_3, pe_cache_iter_3)):
                        ...
                        kv_row_0: pl.Tensor[[1, 512], pl.FP32] = pl.tensor.cast(pl.tensor.view(kv_a_tile_2, [1, 512], [ti_0, 0]), target_type=pl.FP32, mode=2)
                        ...
                        pe_row_0: pl.Tensor[[1, 64], pl.FP32] = pl.tensor.cast(pl.tensor.view(kv_a_tile_2, [1, 64], [ti_0, 512]), target_type=pl.FP32, mode=2)
                        ...
                        kv_cache_7: pl.Tensor[[65536, 512], pl.BFLOAT16] = pl.tensor.assemble(kv_cache_iter_5, pl.tensor.cast(kv_normed_0, target_type=pl.BFLOAT16, mode=2), [cache_row_0, 0])
                        pe_cache_7: pl.Tensor[[65536, 64], pl.BFLOAT16] = pl.tensor.assemble(pe_cache_iter_5, pl.tensor.cast(pe_rot_2, target_type=pl.BFLOAT16, mode=2), [cache_row_0, 0])
                        ...
                        q_nope0_0: pl.Tensor[[1, 128], pl.FP32] = pl.tensor.cast(pl.tensor.view(q_proj_tile_2, [1, 128], [ti_0, q_col0_0]), target_type=pl.FP32, mode=2)
                        q_pe0_0: pl.Tensor[[1, 64], pl.FP32] = pl.tensor.cast(pl.tensor.view(q_proj_tile_2, [1, 64], [ti_0, q_col0_0 + 128]), target_type=pl.FP32, mode=2)
                        ...
                        for blk_0, (blk_topk_idx_iter_6, blk_topk_vals_iter_2, kk_iter_1) in pl.range(0, 2, 1, init_values=(blk_topk_idx_3, blk_topk_vals_1, kk_0)):
                            ...
                            for ss_0, (blk_topk_idx_iter_8, blk_topk_vals_iter_4, kk_iter_3) in pl.range(0, 2048, 1, init_values=(blk_topk_idx_iter_6, blk_topk_vals_iter_2, kk_iter_1)):
                                ...
                                if s_0 < blk_end_0:
                                    ...
                                    kv_s_0: pl.Tensor[[1, 512], pl.FP32] = pl.tensor.cast(pl.tensor.view(kv_cache_7, [1, 512], [cache_s_0, 0]), target_type=pl.FP32, mode=2)
                                    pe_s_0: pl.Tensor[[1, 64], pl.FP32] = pl.tensor.cast(pl.tensor.view(pe_cache_7, [1, 64], [cache_s_0, 0]), target_type=pl.FP32, mode=2)
                        ...
                        for h_0, (attn_row_iter_2, kk_iter_10, s_iter_1) in pl.parallel(0, 128, 1, init_values=(attn_row_1, kk_8, s_0), chunk=8):
                            ...
                            q_nope_0: pl.Tensor[[1, 128], pl.FP32] = pl.tensor.cast(pl.tensor.view(q_proj_tile_2, [1, 128], [ti_0, q_col_0]), target_type=pl.FP32, mode=2)
                            q_pe_0: pl.Tensor[[1, 64], pl.FP32] = pl.tensor.cast(pl.tensor.view(q_proj_tile_2, [1, 64], [ti_0, q_col_0 + 128]), target_type=pl.FP32, mode=2)
                            ...
                            for kk_12, (li_iter_2, mi_iter_2, oi_iter_2, s_iter_3) in pl.range(0, sparse_k_0, 1, init_values=(li_1, mi_1, oi_1, s_iter_1)):
                                ...
                                if s_5 >= 0:
                                    ...
                                    kv_s_1: pl.Tensor[[1, 512], pl.FP32] = pl.tensor.cast(pl.tensor.view(kv_cache_7, [1, 512], [cache_s_1, 0]), target_type=pl.FP32, mode=2)
                                    pe_s_1: pl.Tensor[[1, 64], pl.FP32] = pl.tensor.cast(pl.tensor.view(pe_cache_7, [1, 64], [cache_s_1, 0]), target_type=pl.FP32, mode=2)
                    ...
                    for ti_1, (dispatch_buf_iter_5, pos_iter_1) in pl.range(0, valid_tok_0, 1, init_values=(dispatch_buf_iter_3, pos_0)):
                        ...
                        token_row_0: pl.Tensor[[1, 16384], pl.BFLOAT16] = pl.tensor.cast(pl.tensor.view(attn_tile_3, [1, 16384], [ti_1, 0]), target_type=pl.BFLOAT16, mode=2)
