...
class PredicateTestProgram:
    ...
    def predicate_kernel(self, query_0: pl.Tensor[[64, 128], pl.BFLOAT16], key_0: pl.Tensor[[128, 128], pl.BFLOAT16], value_0: pl.Tensor[[128, 128], pl.BFLOAT16], out_0: pl.Tensor[[64, 128], pl.FP32]) -> pl.Tensor[[64, 128], pl.FP32]:
        for b_idx_0_out, (out_iter_1_outer_l0,) in pl.range(0, 8, 1, init_values=(out_0,)):
            out_iter_1_outer_l1_rv: pl.Tensor[[64, 128], pl.FP32] = self.call_group(predicate_kernel_incore_0_group, b_idx_0_out, key_0, out_0, out_iter_1_outer_l0, query_0, value_0)
            out_iter_1_outer_l0_rv: pl.Tensor[[64, 128], pl.FP32] = pl.yield_(out_iter_1_outer_l1_rv)
        return out_iter_1_outer_l0_rv
    @pl.function(type=pl.FunctionType.InCore)
    def predicate_kernel_incore_0_aic(self, b_idx_0_out: pl.Scalar[pl.INDEX], key_0: pl.Tensor[[128, 128], pl.BFLOAT16], out_0: pl.Tensor[[64, 128], pl.FP32], out_iter_1_outer_l0: pl.Tensor[[64, 128], pl.FP32], query_0: pl.Tensor[[64, 128], pl.BFLOAT16], value_0: pl.Tensor[[128, 128], pl.BFLOAT16]) -> pl.Tensor[[64, 128], pl.FP32]:
        ...
        for b_idx_0_in, (out_iter_1_outer_l1,) in pl.parallel(0, 8, 1, init_values=(out_iter_1_outer_l0,)):
            ...
            pij_0: pl.Tensor[[16, 128], pl.BFLOAT16] = pl.comm.tpop_from_aiv(0)
            pij_0__discard: pl.Tensor[[16, 128], pl.BFLOAT16] = pl.comm.tpop_from_aiv(1)
            oi_0: pl.Tensor[[16, 128], pl.BFLOAT16] = pl.tensor.matmul(pij_0, vj_0, a_trans=False, b_trans=False, c_matrix_nz=False)
            pl.comm.tfree_to_aiv(0)
            __half0__: pl.Tensor[[8, 128], pl.BFLOAT16] = pl.tensor.view(oi_0, __list__(8, 128), __list__(0, 0))
            __half1__: pl.Tensor[[8, 128], pl.BFLOAT16] = pl.tensor.view(oi_0, __list__(8, 128), __list__(8, 0))
            pl.comm.tpush_to_aiv(__half0__, 0)
            pl.comm.tpush_to_aiv(__half1__, 1)
            pl.comm.tfree_to_aiv(1)
        return out_iter_1_outer_l1_rv
    @pl.function(type=pl.FunctionType.InCore)
    def predicate_kernel_incore_0_aiv(self, b_idx_0_out: pl.Scalar[pl.INDEX], key_0: pl.Tensor[[128, 128], pl.BFLOAT16], out_0: pl.Tensor[[64, 128], pl.FP32], out_iter_1_outer_l0: pl.Tensor[[64, 128], pl.FP32], query_0: pl.Tensor[[64, 128], pl.BFLOAT16], value_0: pl.Tensor[[128, 128], pl.BFLOAT16], AIV_IDX: pl.Scalar[pl.INDEX]) -> pl.Tensor[[64, 128], pl.FP32]:
        ...
        for b_idx_0_in, (out_iter_1_outer_l1,) in pl.parallel(0, 8, 1, init_values=(out_iter_1_outer_l0,)):
            ...
            kj_0: pl.Tensor[[64, 128], pl.BFLOAT16] = pl.tensor.view(key_0, [64, 128], [0 + AIV_IDX * 64, 0])
            pl.comm.tpush_to_aic(kj_0, AIV_IDX)
            vj_0: pl.Tensor[[64, 128], pl.BFLOAT16] = pl.tensor.view(value_0, [64, 128], [0 + AIV_IDX * 64, 0])
            pl.comm.tpush_to_aic(vj_0, AIV_IDX)
            sij_0: pl.Tensor[[16, 128], pl.BFLOAT16] = pl.comm.tpop_from_aic()
            mi_0: pl.Tensor[[16, 1], pl.BFLOAT16] = pl.tensor.row_max(sij_0)
            mi_flat_0: pl.Tensor[[1, 16], pl.BFLOAT16] = pl.tensor.deep_reshape(mi_0, [1, 16])
            ...
            oi_0: pl.Tensor[[8, 128], pl.BFLOAT16] = pl.comm.tpop_from_aic(AIV_IDX)
            out_3: pl.Tensor[[64, 128], pl.FP32] = pl.tensor.assemble(out_iter_1_outer_l1, oi_0, [cur_offset_0 + AIV_IDX * 8, 0])
