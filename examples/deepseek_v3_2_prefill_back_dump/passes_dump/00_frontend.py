                ...
                with pl.auto_incore():
                    ...
                    for ob in pl.parallel(0, 56, 1, chunk=8):
                        ...
                        for kb in pl.range(0, 32, 1):
                            ...
                            a_chunk: pl.Tensor[[4, 512], pl.BFLOAT16] = pl.tensor.cast(pl.tensor.view(combined_tile, [4, 512], [0, k0]), target_type=pl.BFLOAT16, mode=2)
                        ...
                        resid: pl.Tensor[[4, 128], pl.FP32] = pl.tensor.cast(pl.tensor.view(hidden_states, [4, 128], [b, p0, o0]), target_type=pl.FP32, mode=2)
                    ...
                    for ob in pl.parallel(0, 56, 1, chunk=8):
                        ...
                        out: pl.Tensor[[16, 4096, 7168], pl.BFLOAT16] = pl.tensor.assemble(out, pl.tensor.cast(down_acc, target_type=pl.BFLOAT16, mode=2), [b, p0, o0])
        return out