...
class DeepSeekV32PrefillBack:
        ...
        for b_0, (out_iter_1,) in pl.parallel(0, 16, 1, init_values=(out_0,), chunk=4):
            ...
            for p0_idx_0, (out_iter_3,) in pl.range(0, tok_blocks_0, 1, init_values=(out_iter_1,)):
                ...
                for ob_0_out, (resid1_tile_iter_1_outer_l0,) in pl.range(0, 7, 1, init_values=(resid1_tile_0,)):
                    resid1_tile_iter_1_outer_l1_rv: pl.Tensor[[4, 7168], pl.FP32] = self.call_group(deepseek_v3_2_prefill_back_layer_incore_0_group, b_0, combined_tile_0, hidden_states_0, ob_0_out, p0_0, resid1_tile_0, resid1_tile_iter_1_outer_l0, wo_0)
                ...
                for ob_1, (down_proj_tile_iter_2, k0_iter_7, kb_iter_3, o0_iter_1) in pl.range(0, 36, 1, init_values=(down_proj_tile_1, k0_5, kb_2, o0_0)):
                    ...
                    for dob_0_out, (down_proj_tile_iter_4_outer_l0,) in pl.range(0, 7, 1, init_values=(down_proj_tile_iter_2,)):
                        down_proj_tile_iter_4_outer_l1_rv: pl.Tensor[[4, 7168], pl.FP32] = self.call_group(deepseek_v3_2_prefill_back_layer_incore_1_group, dob_0_out, down_proj_tile_1, down_proj_tile_iter_2, down_proj_tile_iter_4_outer_l0, mlp_chunk_bf16_0, o0_3, w_down_0)
    ...
    @pl.function(type=pl.FunctionType.InCore)
    def deepseek_v3_2_prefill_back_layer_incore_0_aiv(self, b_0: pl.Scalar[pl.INDEX], combined_tile_0: pl.Tensor[[4, 16384], pl.FP32], hidden_states_0: pl.Tensor[[16, 4096, 7168], pl.BFLOAT16], ob_0_out: pl.Scalar[pl.INDEX], p0_0: pl.Scalar[pl.INDEX], resid1_tile_0: pl.Tensor[[4, 7168], pl.FP32], resid1_tile_iter_1_outer_l0: pl.Tensor[[4, 7168], pl.FP32], wo_0: pl.Tensor[[16384, 7168], pl.BFLOAT16], AIV_IDX: pl.Scalar[pl.INDEX]) -> pl.Tensor[[4, 7168], pl.FP32]:
        ...
        for ob_0_in, (resid1_tile_iter_1_outer_l1,) in pl.parallel(0, 8, 1, init_values=(resid1_tile_iter_1_outer_l0,)):
            ...
            for kb_0, (o_acc_iter_2,) in pl.range(0, 32, 1, init_values=(o_acc_1,)):
                k0_0: pl.Scalar[pl.INDEX] = kb_0 * 512
                _t1: pl.Tensor[[2, 512], pl.FP32] = pl.tensor.view(combined_tile_0, [2, 512], [0 + AIV_IDX * 2, k0_0])
            ...
            _t3: pl.Tensor[[2, 128], pl.BFLOAT16] = pl.tensor.view(hidden_states_0, [2, 128], [b_0 + AIV_IDX * 2, p0_0, o0_0])
    ...
    @pl.function(type=pl.FunctionType.InCore)
    def deepseek_v3_2_prefill_back_layer_incore_1_aic(self, dob_0_out: pl.Scalar[pl.INDEX], down_proj_tile_1: pl.Tensor[[4, 7168], pl.FP32], down_proj_tile_iter_2: pl.Tensor[[4, 7168], pl.FP32], down_proj_tile_iter_4_outer_l0: pl.Tensor[[4, 7168], pl.FP32], mlp_chunk_bf16_0: pl.Tensor[[4, 512], pl.BFLOAT16], o0_3: pl.Scalar[pl.INDEX], w_down_0: pl.Tensor[[18432, 7168], pl.BFLOAT16]) -> pl.Tensor[[4, 7168], pl.FP32]:
        pl.comm.aic_initialize_pipe()
